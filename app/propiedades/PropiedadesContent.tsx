    ...
    <main className="bg-surface min-h-screen">
      ...
      <section className="section-container pt-20 pb-16">
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="label-caps !text-gold">Catálogo</span>
        </div>
        ...
        <div className="mt-12 flex flex-wrap items-center gap-3">
          <span className="label-caps !text-muted">Filtrar por:</span>
            ...
            <button
              ...
              className={`label-caps px-5 py-2.5 rounded-full transition-all ${
                filter === value
                  ...
                  : "border border-line text-warm hover:border-gold hover:text-gold"
              }`}
            >
              {label}
            </button>
      ...
      <section className="section-container py-16 md:py-24">
        {isLoading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="bg-white rounded-card overflow-hidden border border-line/40 animate-pulse">
                <div className="w-full aspect-[4/3] bg-surface-warm" />
                <div className="p-7 space-y-3">
                  <div className="h-3 bg-surface-warm rounded w-1/3" />
                  <div className="h-6 bg-surface-warm rounded w-2/3" />
                  <div className="h-4 bg-surface-warm rounded w-full" />
                  <div className="h-4 bg-surface-warm rounded w-4/5" />
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="text-center py-20 space-y-4">
            ...
            <p className="text-sans-sm text-warm">Hubo un error de conexión. Por favor, intentá de nuevo.</p>
          ...
          <div className="text-center py-20 space-y-3">
            ...
            <p className="text-sans-sm text-warm">
              {filter !== "todos"
