    ...
    <Link
      ...
      className={`group bg-white rounded-[2rem] overflow-hidden border transition-all duration-500 flex flex-col h-full ${
        isUnavailable
          ...
          : "border-[#D2D6CB]/40 hover:border-[#C9A96E]/40 hover:shadow-[0_20px_60px_rgba(201,169,110,0.10)]"
      }`}
    >
      {/* Property Image */}
      ...
      <div className="flex flex-col flex-1 p-7">
        ...
        <div className="flex justify-between items-center">
          ...
          <span className="label-caps text-[#8B9485] group-hover:text-[#C9A96E] flex items-center gap-2 group-hover:gap-3 transition-all">
            Ver más
